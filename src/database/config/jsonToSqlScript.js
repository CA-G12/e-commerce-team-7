...
let content = 'INSERT INTO PRODUCTS(NAME, DESCRIPTION, PRICE, STOCK, CATEGORY, IMAGE, GALARY) VALUES ';
...
const filterContent = (item) => {
    ...
    item = {...item, description: filterdDescription, title: filterdTitle, category: filterdCategory }
    return item;
}
